...
public class DemoClassiAnnidate {
    ...
    public static void main(String[] args) {
        ...
        Persona.Indirizzo ind = p.new Indirizzo();
        
        Persona.Indirizzo indirizzo = p.getIndirizzo();
        indirizzo.setIndirizzi("via roma");
        indirizzo.setNumero(10);
        indirizzo.setCap(10010);
        indirizzo.setCitta("ivrea");
        p.setIndirizzo(indirizzo);
        System.out.println(p.getCognome() + "," + p.getNome() 
                + ", " + p.getIndirizzo().getCitta());
    }
}
